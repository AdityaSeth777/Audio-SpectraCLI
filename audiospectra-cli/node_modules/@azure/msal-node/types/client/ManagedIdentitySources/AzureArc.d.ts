...
export declare class AzureArc extends BaseManagedIdentitySource {
     ...
     */
    static tryCreate(logger: Logger, nodeStorage: NodeStorage, networkClient: INetworkModule, cryptoProvider: CryptoProvider, disableInternalRetries: boolean, _managedIdentityId: ManagedIdentityId): AzureArc | null;
    /**
