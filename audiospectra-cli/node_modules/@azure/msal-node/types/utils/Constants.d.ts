...
export declare const ManagedIdentityHeaders: {
    ...
    readonly CLIENT_SKU: "x-client-SKU";
    readonly CLIENT_VER: "x-client-VER";
    readonly CLIENT_REQUEST_ID: "x-ms-client-request-id";
};
...
export declare const ApiId: {
    ...
    acquireTokenByUserFederatedIdentityCredential: number;
