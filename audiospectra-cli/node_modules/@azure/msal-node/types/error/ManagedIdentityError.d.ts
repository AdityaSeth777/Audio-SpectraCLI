...
export declare const ManagedIdentityErrorMessages: {
    ...
    user_assigned_managed_identity_not_confirmed: string;
...
export declare function createManagedIdentityError(errorCode: string, correlationId: string): ManagedIdentityError;
