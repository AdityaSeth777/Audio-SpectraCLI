...
export declare class NodeAuthError extends AuthError {
     ...
     */
    static createNoAuthCodeInResponseError(correlationId?: string): NodeAuthError;
    /**
     ...
     */
    static createLoopbackServerTimeoutError(correlationId?: string): NodeAuthError;
    /**
     ...
     */
    static createRedirectUriNotSupportedError(correlationId?: string): NodeAuthError;
}
