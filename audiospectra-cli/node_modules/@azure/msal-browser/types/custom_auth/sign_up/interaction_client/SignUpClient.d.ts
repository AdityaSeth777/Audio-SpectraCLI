...
export declare class SignUpClient extends CustomAuthInteractionClientBase {
     ...
     */
    submitPassword(parameters: SignUpSubmitPasswordParams): Promise<SignUpCompletedResult | SignUpCodeRequiredResult | SignUpAttributesRequiredResult>;
    /**
     ...
     */
    submitAttributes(parameters: SignUpSubmitUserAttributesParams): Promise<SignUpCompletedResult | SignUpPasswordRequiredResult | SignUpCodeRequiredResult>;
    /**
