...
import { ICrypto, ITokenBindingKeyManager, IPerformanceClient, Logger } from "@azure/msal-common/browser";
...
export declare class CustomAuthInterationClientFactory {
    ...
    constructor(config: BrowserConfiguration, storageImpl: BrowserCacheManager, browserCrypto: ICrypto, logger: Logger, eventHandler: EventHandler, navigationClient: INavigationClient, performanceClient: IPerformanceClient, customAuthApiClient: ICustomAuthApiClient, customAuthAuthority: CustomAuthAuthority, tokenBindingKeyManager: ITokenBindingKeyManager);
    create<TClient extends CustomAuthInteractionClientBase>(clientConstructor: new (config: BrowserConfiguration, storageImpl: BrowserCacheManager, browserCrypto: ICrypto, logger: Logger, eventHandler: EventHandler, navigationClient: INavigationClient, performanceClient: IPerformanceClient, customAuthApiClient: ICustomAuthApiClient, customAuthAuthority: CustomAuthAuthority, tokenBindingKeyManager?: ITokenBindingKeyManager) => TClient): TClient;
}
