...
export declare class BrowserCacheManager extends CacheManager {
    ...
    constructor(clientId: string, cacheConfig: Required<CacheOptions>, cryptoImpl: ICrypto, logger: Logger, performanceClient: IPerformanceClient, eventHandler: EventHandler, staticAuthorityOptions?: StaticAuthorityOptions, tokenBindingKeyManager?: ITokenBindingKeyManager);
...
export declare const DEFAULT_BROWSER_CACHE_MANAGER: (clientId: string, logger: Logger, performanceClient: IPerformanceClient, eventHandler: EventHandler, staticAuthorityOptions?: StaticAuthorityOptions, tokenBindingKeyManager?: ITokenBindingKeyManager) => BrowserCacheManager;
export {};
