 ...
 * @param algorithm
 */
export declare function sign(key: CryptoKey, data: BufferSource, algorithm: AlgorithmIdentifier): Promise<ArrayBuffer>;
/**
 ...
 * @internal
 */
export declare function computeJwkThumbprint(publicJwk: JsonWebKey, correlationId: string): Promise<string>;
