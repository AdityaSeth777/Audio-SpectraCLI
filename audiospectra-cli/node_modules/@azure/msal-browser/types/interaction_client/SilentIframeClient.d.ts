import { ICrypto, Logger, AuthorizationCodeClient, IPerformanceClient, CommonAuthorizationUrlRequest, ITokenBindingKeyManager } from "@azure/msal-common/browser";
 ...
 * @internal
 */
export type WaitForIframeResponseFn = (iframe: HTMLIFrameElement, request: WaitForIframeRequest) => Promise<string>;
