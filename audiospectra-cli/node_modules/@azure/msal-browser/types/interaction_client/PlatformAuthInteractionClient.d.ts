import { AccountEntity, ICrypto, IPerformanceClient, InProgressPerformanceEvent, Logger, ScopeSet, StoreInCache, TokenClaims, ITokenBindingKeyManager } from "@azure/msal-common/browser";
...
export declare class PlatformAuthInteractionClient extends BaseInteractionClient {
     ...
     */
    private setBrokerErrorTelemetry;
    /**
     ...
     * @param reqTimestamp
     */
    protected handleNativeResponse(response: PlatformAuthResponse, request: PlatformAuthRequest, reqTimestamp: number, storeInCache?: StoreInCache): Promise<AuthenticationResult>;
    /**
     ...
     * @param reqTimestamp
     */
    cacheNativeTokens(response: PlatformAuthResponse, request: PlatformAuthRequest, homeAccountIdentifier: string, idTokenClaims: TokenClaims, tenantId: string, reqTimestamp: number, environment: string, storeInCache?: StoreInCache): Promise<void>;
