import { ICrypto, INetworkModule, Logger, AccountInfo, ServerTelemetryManager, Authority, IPerformanceClient, AzureCloudOptions, StringDict, ITokenBindingKeyManager } from "@azure/msal-common/browser";
...
export declare abstract class BaseInteractionClient {
    ...
    constructor(config: BrowserConfiguration, storageImpl: BrowserCacheManager, browserCrypto: ICrypto, logger: Logger, eventHandler: EventHandler, navigationClient: INavigationClient, performanceClient: IPerformanceClient, correlationId: string, platformAuthProvider?: IPlatformAuthHandler, tokenBindingKeyManager?: ITokenBindingKeyManager);
 ...
 */
export declare function initializeServerTelemetryManager(apiId: number, clientId: string, correlationId: string, browserStorage: BrowserCacheManager, logger: Logger, forceRefresh?: boolean, enabled?: boolean): ServerTelemetryManager;
/**
