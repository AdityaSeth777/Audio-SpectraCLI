...
export declare const popupRelayUnsupportedFlow = "popup_relay_unsupported_flow";
...
export declare const invalidPublicJwk = "invalid_public_jwk";
...
export declare const unsupportedTokenBindingAlgorithm = "unsupported_token_binding_algorithm";
export declare const tokenBindingKeyAlgorithmMismatch = "token_binding_key_algorithm_mismatch";
export declare const tokenBindingKeyJwkThumbprintMismatch = "token_binding_key_jwk_thumbprint_mismatch";
