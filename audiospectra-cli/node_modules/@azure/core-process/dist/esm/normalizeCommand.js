...
import { resolveExecutableWithContext, resolveWindowsCommandInterpreter, } from "./resolveExecutable.js";
 ...
 */
export function normalizeCommand(command, args, context) {
