 ...
 * @returns
 */
export declare function buildTenantProfile(homeAccountId: string, localAccountId: string, tenantId: string, nativeAccountId?: string, idTokenClaims?: TokenClaims): TenantProfile;
/**
